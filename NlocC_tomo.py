...
class process_tomo(ManagedJob):
    ...
    def _Do_tomo(self):
        ...
        from measurements.prog_gate_awg import EspinTomo_NLoC
        self.prog.measurement = EspinTomo_NLoC()
       
        self.prog.measurement.sweeps = 4.0e5
        ...
        name_istate = ['+1_+1']
        ref_state = ['+1_Plus']
        name_istate = ['Plus_+1','PlusI_+1','Plus_-1','PlusI_-1','+1_+1','PlusI_Plus','Plus_PlusI','PlusI_PlusI','Plus_Plus','+1_Plus','+1_PlusI','-1_Plus','-1_PlusI','+1_-1','-1_+1','-1_-1']
        ref_state = ['Plus_Plus','Plus_+1','+1_-1','Plus_PlusI','PlusI_Plus','+1_-1','-1_+1','-1_-1','+1_+1','+1_PlusI','-1_Plus','-1_PlusI','Plus_+1','PlusI_+1','Plus_-1','PlusI_-1']
        ...
        for t in range(len(name_istate)):
            ...
            if self.prog.measurement.state == 'done':          
               ...
               file_name = self.file_pos + '/Nloc_' +  name_istate[t]
