...
class LaserRed( ):
    ...
    def __init__(self, visa_address='GPIB0::2', ao_chan='/Dev2/ao0', co_dev='/Dev2/Ctr1', ci_dev='/Dev2/Ctr2', ci_port='/Dev2/PFI0'):
        ...
        self.ni_task = AnalogOutSyncCount(ao_chan, co_dev, ci_dev, ci_port, ao_range=(-3.0,3.0), duty_cycle=0.9)
    ...
    def _detuning_to_voltage(self, detuning):
        ...
        return detuning * 0.0666666
        
    def get_piezo_voltage(self):
        return (float(self._ask(':SENS:VOLT:PIEZ'))-50.0)*0.06
    
    def get_detuning(self):
        return (float(self._ask(':SENS:VOLT:PIEZ'))-50.0)*0.90
