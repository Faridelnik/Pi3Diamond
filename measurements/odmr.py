...
class ODMR(ManagedJob, GetSetItemsMixin):
    ...
    frequency_begin_p = Range(low=1, high=20e9, value=2.87e9, desc='Start Frequency Pmode[Hz]', label='Begin[Hz]', editor=TextEditor(auto_set=False, enter_set=True, evaluate=float, format_str='%.4e'))
    frequency_end_p = Range(low=1, high=20e9, value=2.88e9, desc='Stop Frequency Pmode[Hz]', label='End[Hz]', editor=TextEditor(auto_set=False, enter_set=True, evaluate=float, format_str='%.4e'))
    frequency_delta_p = Range(low=1e-3, high=20e9, value=1e5, desc='frequency step Pmode[Hz]', label='Delta[Hz]', editor=TextEditor(auto_set=False, enter_set=True, evaluate=float, format_str='%.4e'))
