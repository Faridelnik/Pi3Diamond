...
class NuclearRabi( Pulsed ):
    ...
    mw_frequency   = Range(low=1,      high=20e9,  value=2.7775190e9, desc='microwave frequency', label='MW frequency [Hz]', mode='text', auto_set=False, enter_set=True)
    mw_power       = Range(low=-100.,  high=25.,   value=-27,      desc='microwave power',     label='MW power [dBm]',    mode='text', auto_set=False, enter_set=True)
    t_pi           = Range(low=1.,     high=100000., value=708., desc='length of pi pulse [ns]', label='pi [ns]', mode='text', auto_set=False, enter_set=True)

    rf_frequency   = Range(low=1,      high=20e6,  value=2.794e6, desc='RF frequency', label='RF frequency [Hz]', mode='text', auto_set=False, enter_set=True)
    ...
    tau_end     = Range(low=1., high=1e8,       value=3.0e5,     desc='tau end [ns]',    label='tau end [ns]',     mode='text', auto_set=False, enter_set=True)
